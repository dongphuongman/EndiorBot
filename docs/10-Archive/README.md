...
Historical and internal documents preserved for project archaeology.

These documents may contain references to the original development environment, internal tools, and team conventions from EndiorBot's early development. They are kept for historical reference but are not part of the active documentation.

For current documentation, see the [stage index](../README.md).
