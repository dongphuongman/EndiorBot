 ...
 *
 * @module tests/mtclaw/rag-collection-routing
 * @sprint 115
 */
...
import { RAG_COLLECTIONS, AI_PLATFORM_DOCS_URL } from "../../src/mtclaw/types.js";
import type { MTClawConfig, CrossSystemRoute } from "../../src/mtclaw/types.js";

// ============================================================================
// Test Helpers
// ============================================================================

function createTestConfig(): MTClawConfig {
  return {
...
describe("MTClawBridge.searchKnowledge with options", () => {
...
describe("ChannelRouter.callMTClaw() routing dispatch", () => {
  /** Create a mock MTClawBridge with spied methods */
