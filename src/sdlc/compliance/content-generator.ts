...
import { AGENT_SKILL_MAP, MAX_GENERATED_FILE_SIZE } from "./fix-types.js";
...
export async function generateContent(
  ...
  // Build prompts
  const systemPrompt = buildSystemPrompt(task, deps.snapshot, previousStageOutputs);
...
function buildSystemPrompt(
  ...
  parts.push(`- Include a "## References" section with cross-stage links`);
