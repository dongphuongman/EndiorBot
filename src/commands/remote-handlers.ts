 ...
 *
 * 9 command handlers for Repo Context, Copilot CLI, and Managed Shell.
 * Shared across ALL channels. Moved from channels/telegram/ (Sprint 102).
 * All require actor identity (getLinkedActorId) + shellActorAllowlist.
 *
 * @module commands/remote-handlers
 * @version 2.0.0
 * @authority ADR-024 D4/D5, Sprint 83 + ADR-030 Unified Commands
 */
...
import { sanitizeForEcho } from "./handlers.js";
import type { CommandResult } from "./handlers.js";
