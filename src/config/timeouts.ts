...
export const TIMEOUTS = {
  ...
  /** MCP agent chat timeout (default: 130 s). Env: MCP_GATEWAY_TIMEOUT_MS or MTCLAW_TIMEOUT_MS */
  mtclawAgent: envInt("MCP_GATEWAY_TIMEOUT_MS", envInt("MTCLAW_TIMEOUT_MS", 130_000)),
  /** MCP tool call timeout (default: 30 s). Env: MCP_GATEWAY_DEFAULT_TIMEOUT_MS or MTCLAW_DEFAULT_TIMEOUT_MS */
  mtclawTool: envInt("MCP_GATEWAY_DEFAULT_TIMEOUT_MS", envInt("MTCLAW_DEFAULT_TIMEOUT_MS", 30_000)),
